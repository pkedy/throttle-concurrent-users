...
var tooBusyPath = path.resolve(__dirname, '../html/too-busy.html');
var tooBusyHtml = fs.readFileSync(tooBusyPath, "utf8");
...
function tooBusy(res) {
	res.statusCode = 503;
	res.statusMessage = 'Too busy';
